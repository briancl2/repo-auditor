#!/usr/bin/env python3
"""Replay the retained AS-20..AS-38 work-management signatures."""
...
SIGNATURE_IDS = [f"AS-{index}" for index in (*range(20, 37), 38)]
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run retained AS-20..AS-38 signatures against bounded read-only targets.",
    )
    parser.add_argument(
        "--repo",
        action="append",
...
def main() -> int:
    ...
    payload = {
        ...
        "bounded_non_claims": [
            ...
            "Replay is bounded to the retained AS-20 through AS-38 signatures and the per-signature text scan limit.",
