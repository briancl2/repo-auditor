#!/usr/bin/env python3
"""Replay AS-20..AS-38 work-management signatures against bounded targets."""
...
SIGNATURE_IDS = [f"AS-{index}" for index in range(20, 39)]
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run AS-20..AS-38 against a bounded set of read-only target repositories.",
    )
    parser.add_argument(
        "--repo",
        action="append",
...
def main() -> int:
    ...
    payload = {
        ...
        "bounded_non_claims": [
            ...
            "Replay is bounded to AS-20 through AS-38 and the per-signature text scan limit.",
