...
| `scripts/detect-as-instruction-contradiction.sh` | runtime-loaded deterministic detector | AS-58 instruction-contradiction detector (cited-live-while-dead / mandate-and-forbid) added by issue #194 | Keep tracked as an existing deterministic detector. |
