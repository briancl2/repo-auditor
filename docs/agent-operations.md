...
| detection-signatures | DS-34 through DS-47 plus AS-* signature runner |
...
| `scripts/score-session.sh` | Session grader |
...
agent-surface AS-* checks for instruction root drift, docs-vs-observed host
...
| `scripts/work-close.sh` | Gate 3 post-audit, delta, learnings |
